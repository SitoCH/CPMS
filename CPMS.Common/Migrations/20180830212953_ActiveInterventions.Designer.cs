...
namespace CPMS.Common.Migrations
{
    ...
    [Migration("20180830212953_ActiveInterventions")]
    partial class ActiveInterventions
    {
            ...
            modelBuilder.Entity("CPMS.Common.Entities.JournalEntry", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, DateTime = new DateTime(2018, 2, 2, 8, 30, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 2, JournalId = 1, Person = "SM PCi", Text = "Inizio esercizio" },
                        new { Id = 2, DateTime = new DateTime(2018, 2, 2, 8, 36, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 1, JournalId = 1, Person = "144", Text = "Messaggio PC fronte 1" },
                        new { Id = 3, DateTime = new DateTime(2018, 2, 2, 8, 42, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 1, JournalId = 1, Person = "117", Text = "Messaggio PC fronte 2" },
                        new { Id = 4, DateTime = new DateTime(2018, 2, 2, 8, 45, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 3, JournalId = 1, Person = "117", Text = "Messaggio <b>PC fronte</b> 3" },
                        new { Id = 5, DateTime = new DateTime(2018, 2, 2, 8, 25, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 2, JournalId = 2, Person = "SM PCi", Text = "Inizio esercizio" },
                        new { Id = 6, DateTime = new DateTime(2018, 2, 2, 8, 38, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 2, JournalId = 2, Person = "117", Text = "Messaggio PC retro 1" },
                        new { Id = 7, DateTime = new DateTime(2018, 2, 2, 8, 40, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 1, JournalId = 2, Person = "117", Text = "Messaggio PC retro 2" },
                        new { Id = 8, DateTime = new DateTime(2018, 2, 2, 8, 40, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 1, JournalId = 2, Person = "144", Text = "Messaggio PC retro 3" },
                        new { Id = 9, DateTime = new DateTime(2018, 2, 2, 8, 47, 0, 0, DateTimeKind.Unspecified), JournalEntryChannelId = 2, JournalId = 2, Person = "Care team", Text = "Messaggio PC retro 4" }
                    );
                });
