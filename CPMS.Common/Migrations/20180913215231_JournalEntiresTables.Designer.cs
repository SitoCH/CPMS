...
namespace CPMS.Common.Migrations
{
    ...
    [Migration("20180913215231_JournalEntiresTables")]
    partial class JournalEntiresTables
    {
            ...
            modelBuilder.Entity("CPMS.Common.Entities.JournalEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, DateTime = new DateTime(2018, 2, 2, 8, 36, 0, 0, DateTimeKind.Unspecified), Direction = 0, JournalEntryChannelId = 1, JournalId = 1, Message = "Messaggio PC fronte 1", Name = "144" },
                        new { Id = 3, DateTime = new DateTime(2018, 2, 2, 8, 42, 0, 0, DateTimeKind.Unspecified), Direction = 1, JournalEntryChannelId = 1, JournalId = 1, Message = "Messaggio PC fronte 2", Name = "117" },
                        new { Id = 4, DateTime = new DateTime(2018, 2, 2, 8, 45, 0, 0, DateTimeKind.Unspecified), Direction = 0, JournalEntryChannelId = 3, JournalId = 1, Message = "Messaggio <b>PC fronte</b> 3", Name = "117" },
                        new { Id = 5, DateTime = new DateTime(2018, 2, 2, 8, 25, 0, 0, DateTimeKind.Unspecified), Direction = 0, JournalEntryChannelId = 2, JournalId = 2, Message = "Inizio esercizio", Name = "SM PCi" },
                        new { Id = 6, DateTime = new DateTime(2018, 2, 2, 8, 38, 0, 0, DateTimeKind.Unspecified), Direction = 0, JournalEntryChannelId = 2, JournalId = 2, Message = "Messaggio PC retro 1", Name = "117" },
                        new { Id = 7, DateTime = new DateTime(2018, 2, 2, 8, 40, 0, 0, DateTimeKind.Unspecified), Direction = 1, JournalEntryChannelId = 1, JournalId = 2, Message = "Messaggio PC retro 2", Name = "117" },
                        new { Id = 8, DateTime = new DateTime(2018, 2, 2, 8, 40, 0, 0, DateTimeKind.Unspecified), Direction = 0, JournalEntryChannelId = 1, JournalId = 2, Message = "Messaggio PC retro 3", Name = "144" },
                        new { Id = 9, DateTime = new DateTime(2018, 2, 2, 8, 47, 0, 0, DateTimeKind.Unspecified), Direction = 0, JournalEntryChannelId = 2, JournalId = 2, Message = "Messaggio PC retro 4", Name = "Care team" },
                        new { Id = 10, DateTime = new DateTime(2018, 2, 2, 8, 50, 0, 0, DateTimeKind.Unspecified), Direction = 1, JournalEntryChannelId = 2, JournalId = 2, Message = "<h1>Titolo</h1><div><br></div><div>Testo messaggio.</div><div><span style=\"color: rgb(230, 0, 0);\">Informazioni importanti:</span></div><div><br></div><ol><li>Info 1</li><li>Info 2</li><li>Info 3</li></ol><div><br></div><div><br></div>", Name = "Care team" }
                    );
                });
